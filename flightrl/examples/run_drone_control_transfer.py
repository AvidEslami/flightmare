...
def main():
    ...
    if args.train:
        ...
        for i in range(rounds):
            if(i==0):
                ...
                env.wrapper.reset_range(env._observation, init_zlower+2*i, init_zupper+2*i, init_xylower-2*i, init_xyupper+2*i, True)
                model = PPO2(
                    tensorboard_log=saver.data_dir,
                    policy=MlpPolicy,  # check activation function
                    policy_kwargs=dict(
    ...
    # # Testing mode with a trained weight
        ...
        # env.wrapper.reset_range(env._observation, 11, 13, -11, 11, True)
