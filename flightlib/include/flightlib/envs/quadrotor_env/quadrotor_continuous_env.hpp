...
class QuadrotorContinuousEnv final : public EnvBase {
 public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW

  QuadrotorContinuousEnv();
  QuadrotorContinuousEnv(const std::string &cfg_path);
  ~QuadrotorContinuousEnv();
  ...
  friend std::ostream &operator<<(std::ostream &os,
                                  const QuadrotorContinuousEnv &quad_env);
 ...
 private:
  ...
  Command cmd_;
  Logger logger_{"QaudrotorContinuousEnv"};
