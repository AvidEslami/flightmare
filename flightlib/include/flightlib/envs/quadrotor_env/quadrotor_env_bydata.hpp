...
class QuadrotorEnvByData final : public EnvBase {
 public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW

  QuadrotorEnvByData();
  QuadrotorEnvByData(const std::string &cfg_path);
  ~QuadrotorEnvByData();
  ...
  friend std::ostream &operator<<(std::ostream &os,
                                  const QuadrotorEnvByData &quad_env);
 ...
 private:
  ...
  Command cmd_;
  Logger logger_{"QuadrotorEnvByData"};
